...
void guess(int* haystacks) {
  ...
  while (guess_num < 3) {
    ...
    if (guess_num == 2) {
      printf("I'm out of time. I guess I lost it forever...\n");
      return;
    }
    else {
...
int main(int argc, char **argv) {
  ...
  printf("Help! I have lost my favorite needle in one of my 4096 identical haystacks! Could you help me find it?\n");
  setup_haystacks();
  exit(0);
} 