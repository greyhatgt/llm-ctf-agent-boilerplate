...
if __name__ == '__main__':
    ...
    # p.sendline(b"250382")
    opener_string = b"Enter your 32-bit password (e.g., 01010101010101010101010101010101). Remember, it needs to map to {correct_str}! Hint: a ^ b = c!\n"
    if opener_string in p.recvall():
        print("OK!")
        exit(0)
    else:
        print("FAILED!")
