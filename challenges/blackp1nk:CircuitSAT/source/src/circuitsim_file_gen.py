...
"""
file_template = None
with open('/src/templates/template_min.sim', 'r') as file:
...
with open('/src/templates/comp_or_gate_template.json', 'r') as file:
...
with open('/src/templates/subcircuit_template.json', 'r') as file:
...
if __name__ == "__main__":
    ...
    exit(0)
    # tmp = None
    # with open('/src/templates/template_min_ref.sim', 'r') as file:
